...
namespace MusicPlaylistManager.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Genre,Description")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaylistId,Name,Genre,Description")] Playlist playlist)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var playlist = await _context.Playlists.FirstOrDefaultAsync(m => m.PlaylistId == id);
            if (playlist == null)
            {
                return NotFound();
            }
